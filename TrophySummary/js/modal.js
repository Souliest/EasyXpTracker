...
export function openMissingGamePrompt(queue, callbacks) {
    ...
    const showNext = () => {
        ...
        keepBtn.addEventListener('click', () => {
            ...
            if (doAll) {
                // Apply Keep to the rest of the queue (game already handled above).
                for (const g of remaining.slice(1)) callbacks.onKeep(g, false);
                _closeMissingModal();
                callbacks.onDone();
            } else {
        ...
        removeBtn.addEventListener('click', () => {
            ...
            if (doAll) {
                // Apply Remove to the rest of the queue (game already handled above).
